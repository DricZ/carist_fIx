                ...
                <div id='content'>
                    ...
                    <div class='row' style='padding-left: 40px;padding-right: 40px;'>
                        <div class='col' style='padding-left: 30px;'>
                            <div class='row'>
                                <div class='col-md-2'>
                                    <img src='https://life.carist.id/img/carist%20only%20cropped.png' style='width: 100px;'>
                                </div>
                    ...
                    $message .= "
                        ...
                        <div class='row mb-2'>
                            ...
                            <div class='col-md-8' style='justify-content: right;display: flex;padding-top: 20px;padding-bottom: 20px;padding-right: 20px;'>
                                <img src='https://life.carist.id/img/qr-crop.jpg' style='width: 25%;'>
                            </div>
                        </div>
