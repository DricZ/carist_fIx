                    ...
                    <div class="row pl-5 pr-5">
                        <div class="col-md-3">
                            <div class="form-group" style="padding-right: 20px;">
                                ...
                                <input type="file" class="form-control" name="logo" id="customFile" style="margin-bottom: 20px;" required />
                                <img id='img-upload'/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="col-md-10">
                                    <input type="number" id="fc" class="form-control" name="fc" value="0">
                                </div>
                            </div><br>
                            ...
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="col-md-10">
                                    <input type="number" id="sc" class="form-control" name="sc" value="0">
                                </div>
                            </div><br>
                            ...
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="col-md-10">
                                    <input type="number" id="price" class="form-control" name="price" value="0">
                                </div>
                            </div><br>
