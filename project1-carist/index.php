...
<body>
  ...
  <header id="header" class="position-absolute">
    <div class="container d-flex align-items-center">
      ...
      <!-- <h1 class="logo me-auto"><a href="index.html">Test</a></h1> -->
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="md-p-l-20 md-p-r-20 xs-no-padding">
          <h5 class="block-title hint-text no-margin">WHO ARE WE?</h5>
          <div class="row">
            <div class="col-sm-5 col-md-4">
              <h1 class="m-t-5">Your Personal Branding Consultant.</h1>
            </div>
            <div class="col-sm-7 col-md-8 no-padding xs-p-l-15 xs-p-r-15">
              <div class="p-t-20 p-l-35 md-p-l-5 md-p-t-15">
                <p>People judge the book by its cover, that is the undeniable fact. Therefore, customer perception and experience plays a major role in today's competition. We are here to help your brand stand out loud, win businesses, gain more awareness, and delivering exceptional brand experience.</p>
                <p class="hint-text font-arial small-text col-md-7 no-padding"></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="quotes" class="quotes section-bg">
      ...
      <!-- <div class="swiper-container swiper-container-horizontal" id="testimonials_slider">
        <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(-1024px, 0px, 0px);">

          <div class="swiper-slide swiper-slide-prev" style="width: 1024px;">
          ...
          <div class="swiper-slide swiper-slide-active" style="width: 1024px;">
            <div class="container text-left">
              <h3 class="m-b-30">“Outstanding design works. Their works are neat and thoughtful. We love how they explore and expand the ideas”</h3>
              <h6 class="block-title hint-text fs-12">TRAVIS GOH – MARKETING MANAGER OF ALLIANCE AVIATION.</h6>
            </div>
          </div>
        ...
        <div class="container">
          <div class="swiper-pagination relative pull-left swiper-pagination-clickable">
    ...
    <section id="cliens" class="cliens section-bg">
      <div class="container">
        ...
        <div id="c-clients" class="carousel slide" data-bs-ride="carousel">
          ...
          <!-- Indicators/dots -->
          <!-- <div class="carousel-indicators">
            <button type="button" data-bs-target="#c-clients" data-bs-slide-to="0" class="active"></button>
            <button type="button" data-bs-target="#c-clients" data-bs-slide-to="1"></button>
            <button type="button" data-bs-target="#c-clients" data-bs-slide-to="2"></button>
          </div> -->
          ...
          <!-- Left and right controls/icons -->
          <!-- <button class="carousel-control-prev" type="button" data-bs-target="#c-clients" data-bs-slide="prev">
            <span class="carousel-control-prev-icon"></span>
          </button>
          <button class="carousel-control-next" type="button" data-bs-target="#c-clients" data-bs-slide="next">
            <span class="carousel-control-next-icon"></span>
          </button> -->
        </div>
        ...
        <div class="row">
          <div class="col-lg-2 col-md-6 footer-contact" style="margin-left: 34%; padding:0%" >
            <p style="color: white;">
              ...
              Opening hours: 09.00 - 17.00 WIB<br>
            </p>
          </div>
