...
<head>
	...
	<title>BlastMe Admin Page | CSV Transaction Report</title>
				...
				<div class="col-12 col-md-8 col-lg-9 col-xl-10 pl-lg-4">
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0">CSV Transaction Report - Parameter</h5>
								</div>
								<div class="card-body">
									<form>
										...
										<div class="form-group">
											<div class="row">
												<div class="col-sm-12" align="right">
													<button class="btn btn-primary" id="btnViewTransaction" name="btnViewTransaction">View CSV Report List</button>&nbsp;
												</div>
											</div>
										</div>
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0">Generated CSV Reports</h5>
								</div>
								<div class="card-body">
									<br/><br/>
									<div id="reportpart">
	...
	<script>
		$(document).ready(function(){
			...
			$('#btnViewTransaction').click(function(e){
				...
				$.post('CSVTransactionReportsDetail.php', { clientId: trxClientId, jck: '801fbf1916c335d616903bf6c6710fea434254a0' }, function(data){
					if(data!=null){
